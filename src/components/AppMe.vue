...
<div id="setting" class="mui-page">
	<!--页面标题栏开始-->
	<div class="mui-navbar-inner mui-bar mui-bar-nav b-line">
		...
		<div class="mui-scroll-wrapper ">
			<div class="mui-scroll ">
				<ul class="mui-table-view mui-table-view-chevron">
					<li class="mui-table-view-cell mui-media b-line">
						<a class="mui-navigate-right t-line" href="#account">
							<img class="mui-media-object mui-pull-left head-img" id="head-img" src="">
							<div class="mui-media-body">
								{{user.nikename}}
								<p class='mui-ellipsis'>时尚女王</p>
							</div>
						</a>
					</li>
				</ul>
				<ul class="mui-table-view mui-table-view-chevron t-line">
					<li class="mui-table-view-cell b-line">
						<a href="#account1" class="mui-navigate-right">我的订单</a>
					</li>
				</ul>
				<ul class="mui-table-view mui-table-view-chevron t-line">
					<li class="mui-table-view-cell b-line">
						<a href="#privacy" class="mui-navigate-right">收货地址</a>
					</li>
					<li class="mui-table-view-cell b-line">
				...
				<ul class="mui-table-view mui-table-view-chevron b-line">
					<li class="mui-table-view-cell t-line">
						<a href="#about" class="mui-navigate-right">关于海淘购 <i class="mui-pull-right update">2.0</i></a>
					</li>
				</ul>
				<ul class="mui-table-view b-line">
					<li class=" t-line" style="text-align: center; padding:14px 0 ">
						<div style='color:#ff3366; display:inline-block; width:100%' @click='logout'>注销</div>
					</li>
				</ul>
			</div>
		</div>
		...
		<div class="mui-scroll-wrapper">
			<div class="mui-scroll">
				<ul class="mui-table-view">
					...
					<li class="mui-table-view-cell t-line">
						<a>姓名<span class="mui-pull-right">艾薇儿</span></a>
					</li>
					<div class="b-line"></div>
				</ul>
				<ul class="mui-table-view t-line">
					<li class="mui-table-view-cell b-line">
						<a>QQ号<span class="mui-pull-right">88888888</span></a>
					</li>
					<li class="mui-table-view-cell b-line">
						<a>手机<span class="mui-pull-right">885444444</span></a>
					</li>
					<li class="mui-table-view-cell b-line">
						<a>邮箱地址<span class="mui-pull-right">haitao@me.com</span></a>
					</li>
				</ul>
			</div>
		</div>
				...
				<div class="">
					<div style="padding:5px 10px;" class="b-line">
						<div id="segmentedControl" class="mui-segmented-control mui-segmented-control-inverted mui-segmented-control-primary">
							...
							<a class="mui-control-item" href="#item2">代付款</a>
							<a class="mui-control-item" href="#item3">待收货</a>
							<a class="mui-control-item" href="#item3">待评价</a>
							<a class="mui-control-item" href="#item3">退款退货</a>
						</div>
					</div>
					<div>
						<div id="item1" class="mui-control-content mui-active" style="height:800px">
							<div class="mui-page-content">
								<div class="mui-scroll-wrapper" data-scroll="8">
									<div class="mui-scroll" style="transform: translate3d(0px, 0px, 0px) translateZ(0px); transition-duration: 0ms;">
										<ul class="mui-table-view mui-table-view t-line" id="" style="margin-top:0">
											<li class="mui-table-view-cell mui-table-view-cell mui-media b-line mui-transitioning">
												...
												<div class="mui-slider-handle mui-table" style="transform: translate(0px, 0px);">
													<a href="javascript:;">
														<img class="mui-media-object mui-pull-left" src="assets/images/ad1.jpg">
														<div class="mui-media-body">¥112.50
															<p class="mui-ellipsis">春季新款韩版小清新百搭短款重工花朵刺绣修身显瘦夹克牛仔外套</p>
														</div>
													</a>
												</div>
											</li>
											<li class="mui-table-view-cell  mui-table-view-cell mui-media b-line">
												...
												<div class="mui-slider-handle mui-table">
													<a href="javascript:;">
														<img class="mui-media-object mui-pull-left" src="assets/images/ad2.jpg">
														<div class="mui-media-body">¥112.50
															<p class="mui-ellipsis">春季新款韩版小清新百搭短款重工花朵刺绣修身显瘦夹克牛仔外套</p>
														</div>
													</a>
											...
											<li class="mui-table-view-cell  mui-table-view-cell mui-media b-line">
												...
												<div class="mui-slider-handle mui-table">
													<a href="javascript:;">
														<img class="mui-media-object mui-pull-left" src="assets/images/ad3.jpg">
														<div class="mui-media-body">¥112.50
															<p class="mui-ellipsis">春季新款韩版小清新百搭短款重工花朵刺绣修身显瘦夹克牛仔外套</p>
														</div>
													</a>
									...
									<div class="mui-scrollbar mui-scrollbar-vertical"><div class="mui-scrollbar-indicator" style="transition-duration: 0ms; display: none; height: 686px; transform: translate3d(0px, 0px, 0px) translateZ(0px);"></div></div></div>
							</div>
						</div>
...
<div id="notifications" class="mui-page">
	<div class="mui-navbar-inner mui-bar mui-bar-nav">
		...
		<h1 class="mui-center mui-title">消息通知</h1>
	</div>
	<div class="mui-page-content">
		<div class="mui-scroll-wrapper">
			<div class="mui-scroll">
				...
				<ul class="mui-table-view mui-table-view-chevron t-line">
					<li class="mui-table-view-cell b-line">
						<a href="#notifications_disturb" class="mui-navigate-right">消息免打扰</a>
					</li>
				</ul>
				<div></div>
			</div>
...
<div id="notifications_disturb" class="mui-page">
	<div class="mui-navbar-inner mui-bar mui-bar-nav b-line">
		...
		<h1 class="mui-center mui-title">消息免打扰</h1>
	</div>
	<div class="mui-page-content">
		<div class="mui-scroll-wrapper">
			<div class="mui-scroll">
				<ul class="mui-table-view mui-table-view-radio t-line">
					<li class="mui-table-view-cell b-line">
...
<div id="privacy" class="mui-page">
	<div class="mui-navbar-inner mui-bar mui-bar-nav">
		...
		<a href="#address" type="button" class="mui-left  mui-btn  mui-btn-link mui-btn-nav mui-pull-right">
		...
		<div class="mui-scroll-wrapper">
			<div class="mui-scroll">
				<ul class="mui-table-view mui-table-view-radio t-line">
					...
					<li class="mui-table-view-cell b-line">
						<p><a  href="#address" style="padding-right:20px"><span class="mui-icon mui-icon-compose"></span>编辑</a> <a href="#"><span class="mui-icon mui-icon-trash"></span>删除</a></p>
					</li>
				</ul>
				<ul class="mui-table-view mui-table-view-radio t-line">
					<li class="mui-table-view-cell b-line">
		...
		<div class="mui-scroll-wrapper">
			<div class="mui-scroll">
					...
					<form class="mui-input-group">
						...
						<div class="mui-input-row b-line">
							<label>手机号：</label>
							<input type="text" class="mui-input-clear" placeholder="1880108888888" data-input-clear="3"><span class="mui-icon mui-icon-clear mui-hidden"></span>
						</div>
						<div class="mui-input-row b-line">
							<label>省市区：</label>
							<input type="text" class="mui-input-speech mui-input-clear" placeholder="北京市海淀区" data-input-clear="4" data-input-speech="4"><span class="mui-icon mui-icon-clear mui-hidden"></span><span class="mui-icon mui-icon-speech"></span>
						</div>
						<div class="mui-input-row b-line">
							<label>详细地址：</label>
							<input type="text" class="mui-input-clear" placeholder="中关村大街23号" data-input-clear="3"><span class="mui-icon mui-icon-clear mui-hidden"></span>
						</div>
						<div class="mui-button-row b-line" style="padding:15px 0; height:auto">
...
<div id="about" class="mui-page">
	<div class="mui-navbar-inner mui-bar mui-bar-nav">
		<button type="button" class="mui-left mui-action-back mui-btn  mui-btn-link mui-btn-nav mui-pull-left">
			<span class="mui-icon mui-icon-arrowleft"></span>设置
		</button>
		<h1 class="mui-center mui-title">关于海淘购</h1>
	</div>
	<div class="mui-page-content">
		<div class="mui-scroll-wrapper">
			<div class="mui-scroll">
				<ul class="mui-table-view t-line">
					...
					<li class="mui-table-view-cell b-line mui-plus-visible">
					...
					<li id="check_update" class="mui-table-view-cell b-line">
...
<div id="feedback" class="mui-page feedback">
	<div class="mui-navbar-inner mui-bar mui-bar-nav">
		...
		<button id="submit" class="mui-btn mui-btn-blue mui-btn-link mui-pull-right" style="width:auto">发送</button>
...
<nav class="mui-bar mui-bar-tab">
	<div class="t-line">
		<router-link to='/home' class="aui-tab-item">
			<span class="mui-icon mui-icon-home"></span>
			<span class="mui-tab-label">首页</span>
		</router-link>
		
		<router-link to='/category' class="aui-tab-item">
			<span class="mui-icon mui-icon-extra mui-icon-extra-class"></span>
			<span class="mui-tab-label">分类</span>
		</router-link>
		
		<router-link to='/car' class='aui-tab-item'>
			<span class="mui-icon mui-icon-extra mui-icon-extra-cart"></span>
			<span class="mui-tab-label">购物车</span>
		</router-link>
		
		<router-link to='/me' class='aui-tab-item mui-active'>
...
export default {
    ...
    function shareMessage(share, ex) {
        ...
        msg.thumbs = ["_www/assets/images/logo.png"];
    ...
    function defaultImg() {
        if(mui.os.plus){
            plus.io.resolveLocalFileSystemURL("_doc/head.jpg", function(entry) {
                ...
                document.getElementById("head-img").src = 'assets/images/ad1.jpg';
                document.getElementById("head-img1").src = 'assets/images/ad1.jpg';
            })
        }else{
            document.getElementById("head-img").src = 'assets/images/ad1.jpg';
            document.getElementById("head-img1").src = 'assets/images/ad1.jpg';
